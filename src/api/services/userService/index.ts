...
): Promise<AxiosResponse<AccountResponseType>> => {
...
export const deleteUser = (
  userId: string,
): Promise<AxiosResponse<AccountIdResponseType>> => {
  return axiosClient.delete(`/Admin/account/${userId}`);
};

export const blackList = (
  user: AccountBlackListResponseType,
): Promise<AxiosResponse<AccountBlackListResponseType>> => {
